...
#
# Original from tt_SolidInspector2.
#
#-------------------------------------------------------------------------------
...
module KLP::Plugins::SolidsMakeShopDrawing
  module Settings
    ...
    # KLP::Plugins::SolidsMakeShopDrawing::Settings.debug_mode = true
    ...
    # KLP::Plugins::SolidsMakeShopDrawing::Settings.local_error_server = true
